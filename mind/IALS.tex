	...
	\begin{tikzpicture}[scale=0.75,transform shape]
		...
		\GraphInit[vstyle=Normal]
		{
			...
			\Vertex[x=3.6,y=5.9]{56}
			{
				...
				\SetVertexLabel
				\Vertex[x=3.2,y=6.3,L=You,LabelOut=true]{57}
			}

...
\begin{figure}
	...
	\begin{tikzpicture}[scale=0.54,transform shape]
		...
		\Vertex[x=3.6,y=5.9]{56}
		{
			...
			\SetVertexLabel
			\Vertex[x=3.2,y=6.3,L=You,LabelOut=true,Ldist=5pt]{57}
		}
		...
		\Vertex[x=8.1,y=6.7]{92}
		{
			...
			\Vertex[x=9.3,y=3.3]{78}
			\Vertex[x=9.1,y=3.1]{79}
			\Vertex[x=9.1,y=1.7]{80}
			\Vertex[x=9.0,y=1.5]{81}
			\Vertex[x=7.0,y=1.0]{82}
			\Vertex[x=6.4,y=0.2]{83}
			\Vertex[x=6.6,y=0.4]{84}
			\Vertex[x=5.3,y=0.4]{85}
			\Vertex[x=4.2,y=0.1]{86}
			\Vertex[x=3.3,y=0.0]{87}
			\Vertex[x=1.8,y=0.1]{88}
			\Vertex[x=2.4,y=0.1]{89}
			\Vertex[x=1.4,y=0.0]{90}
			\Vertex[x=0.5,y=1.0]{91}
			\Vertex[x=8.2,y=7.3]{93}
			\Vertex[x=8.4,y=6.2]{94}
...
% Brahman as the supremum of identities in the observed universe. Any ancestor of Brahman would also therefore be a brahman. Relationship of supremum to anonymous root?

...
\begin{enumerate}[label={[\textbf{\arabic*}]},start=0]
	...
	\item \begin{enumerate}
		...
		\item Some causal orderings are preferable to others. (\emph{Axiom of Desire}\footnote{Desire may be definable mathematically as a field (in the physical sense) on the space of causal orderings.})
		\end{enumerate}
